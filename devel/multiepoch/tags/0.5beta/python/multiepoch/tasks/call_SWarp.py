...
class Job(BaseJob):
    ...
    def get_swarp_cmd_list(self, swarp_scilist, swarp_wgtlist, swarp_flxlist, comb_sci, comb_wgt, swarp_parameters={}):
        ...
        for BAND in self.ctx.BANDS:
            ...
            # 1. The call 
            cmd = []
            pars["WEIGHT_IMAGE"]   = "@%s" % (swarp_wgtlist[BAND]) # custom weights
    ...
    def get_swarp_input_lists(self, **kwargs):
        ...
        #swarp_swglist = {} # File with list of swarp weight names -- i.e "_wgt.fits" files -- NOT NEEDED
        ...
        #swarp_weights = {} # Array with custom weights for SWarp -- NOT NEEDED
        ...
        for BAND in self.ctx.BANDS:
            ...
            # THESE NAMES ARE NOW SET in the Definition's function
            ...
            # swarp_swglist[BAND] = os.path.join(self.ctx.basedir,"aux","%s_%s_swg.list" % (filepattern,BAND)) -- NOT NEEDED
