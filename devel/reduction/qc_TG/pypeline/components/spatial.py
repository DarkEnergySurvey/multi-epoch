...
#########
	...
	if len(ra_all_gal) > 0 and len(dec_all_gal) > 0:
		...
		P.plotSmooth(plotName1,ra_all_gal,dec_all_gal,ramax,ramin,decmin,decmax)
	...
	if len(ragal) > 0 and len(decgal) > 0:
		...
		io.addOutput(plotName2,"spatial_distrib_gl_plot","plot",'Spatial Distribution (Galaxies)','Spatial distribution of galaxies.',"file")
	else:
	...
	if len(rastar) > 0 and len(decstar) > 0:
		...
		io.addOutput(plotName3,"spatial_distrib_st_plot","plot",'Spatial Distribution (Point Sources)','Spatial distribution of point sources.',"file")
	else:
