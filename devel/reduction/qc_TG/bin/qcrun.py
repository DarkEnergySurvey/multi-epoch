...
sys.path.insert(0,options.qchome+'/lib/python/')
sys.path.insert(0,options.qchome+'/lib/python/setuptools-0.6c6-py2.3.egg')
...
#	img_file = baseName+"_im.fits"
	...
	(pype.doc.xpath('/job/components/component[@id="classification1"]/config/scalar[@id="band"]')[0]).setAttributeNS(None, u'value', filt)
#	pype.printConfig()
	n = n + 1
	print img_file+"; Processing CCD #"+str(n)
	pype.execute()
